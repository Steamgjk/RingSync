...
'''
  ...
  hooks = [tr.BroadcastGlobalVariablesHook(0),
           ...
           tf.train.LoggingTensorHook(tensors={'step': global_step, 'loss': cross_entropy_mean}, every_n_iter=10),
           ]
  ...
  with tf.train.MonitoredTrainingSession(checkpoint_dir=checkpoint_dir,
      ...
      while not mon_sess.should_stop():
        ...
        if do_distort_images:
          (train_bottlenecks,
           train_ground_truth) = get_random_distorted_bottlenecks(
               mon_sess, image_lists, FLAGS.train_batch_size, 'training',
        ...
        train_accuracy, cross_entropy_mean = mon_sess.run(
